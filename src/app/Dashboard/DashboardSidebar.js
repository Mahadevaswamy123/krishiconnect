...
const DashboardSidebar = () => {
  ...
  const navItems = [
    ...
    // { name: "Vehicle Subsidies", path: "/Dashboard/subsidies" },
    { name: "Book Seeds & Fertilizers", path: "/Dashboard/bookings" },
    { name: "Government Schemes", path: "/Dashboard/schema" },
    { name: "Community Forum", path: "/Dashboard/queries" },
    // { name: "Farming Techniques", path: "/Dashboard/techniques" },
    // { name: "Weather & Market", path: "/dashboard/weather-market" },
  ];

  return (
    <div className="flex">
      {/* Sidebar */}
      <aside className="w-64 mt-2 h-screen bg-green-700 dark:bg-gray-900 text-white fixed top-0 left-0 shadow-lg sm:w-16 sm:overflow-hidden sm:flex-col sm:items-center sm:justify-between sm:gap-4 lg:w-64">
